...
function iniciarApp() {
    ...
    botonesPaginador(); //Agraga o quita los botones del paginador
    paginaAnterior();
    paginaSiguiente();
...
function mostrarSeccion() {
    //Oculatar la sección que tenga la clase de mostar
...
function seleccionarServicio(servicio) {
    ...
    //Identificar el elemento la que se le da click
...
function mostarResumen() {
   ...
   const fechaFormateada = fechaUTC.toLocaleDateString('es-MX', opciones);
    ...
    botonReservar.onclick = recevarCita;
